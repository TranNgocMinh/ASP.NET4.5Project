...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    ...
    <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=ngocminhtranEntities" DefaultContainerName="ngocminhtranEntities" EnableFlattening="False" EntitySetName="Genres" OnContextCreating="EntityDataSource1_ContextCreating" OnSelecting="EntityDataSource1_Selecting">
